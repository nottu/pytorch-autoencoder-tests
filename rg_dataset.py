...
class LRG(data.Dataset):
    def __init__(self, sz=64, use_kittler=False, n_aug=10, twice=False):
...
class UNLRG_C(data.Dataset):
    def __init__(self, sz=64, use_kittler=False, n_aug=10):
        self.use_kittler = use_kittler
        self.n_aug = n_aug
        self.__load_data()
        self.data_len = len(self.data)
